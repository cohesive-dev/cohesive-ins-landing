...
export default function StartupBundle({ slug }: { slug: string }) {
  return <section aria-labelledby="startup-bundle-heading" className="mt-8 max-w-3xl rounded-2xl border border-blue-200 bg-blue-50 p-5 sm:p-7 print:hidden">
    ...
    <h2 id="startup-bundle-heading" className="mt-2 text-2xl font-bold">{STARTUP_BUNDLE.heading}</h2>
    <p className="mt-3 text-base leading-7 text-slate-700">{STARTUP_BUNDLE.summary}</p>
    <div className="mt-5 flex flex-wrap items-center gap-4">
      <GuideQuoteLink slug={slug} placement="startup-bundle" label={STARTUP_BUNDLE.cta} />
